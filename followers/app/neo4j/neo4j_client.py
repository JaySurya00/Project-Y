...
class Neo4jWrapper:
    ...
    async def connect(self):
        try:
            self.__driver= GraphDatabase.driver(NEO4J_URI, auth=(NEO4J_USERNAME, NEO4J_PASSWORD))
    ...
    async def follow(self,followee_id: int, follower_id: int):
        ...
        """
        result, summary, key = driver.execute_query( query, follower_id= follower_id, followee_id= followee_id,database_="neo4j")
